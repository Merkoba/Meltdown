...
class Snippet(tk.Frame):
    def __init__(self, parent: Output, content: str, language: str) -> None:
        ...
        self.header_text = tk.Label(self.header, text=header_text, font=config.get_output_font())
        ...
        self.header_copy = tk.Label(self.header, text="Copy", font=config.get_output_font())
    ...
    def update_font(self) -> None:
        self.text.configure(font=config.get_snippet_font())
        self.header_text.configure(font=config.get_output_font())
        self.header_copy.configure(font=config.get_output_font())
        self.update_size()
